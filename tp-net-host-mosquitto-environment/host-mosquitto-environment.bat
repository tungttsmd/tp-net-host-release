...
if not exist "%ACL_FILE%" (
    ...
    echo topic write winwtsvc/#>> "%ACL_FILE%"
    echo topic write winftsvc/#>> "%ACL_FILE%"
    echo.>> "%ACL_FILE%"
    echo # Anonymous: read only>> "%ACL_FILE%"
    echo topic read winatsvc/+/control>> "%ACL_FILE%"
    echo topic read winttsvc/+/control>> "%ACL_FILE%"
    echo.>> "%ACL_FILE%"
    ...
    echo user watcher>> "%ACL_FILE%"
    echo topic readwrite winwtsvc/#>> "%ACL_FILE%"
    echo topic readwrite winftsvc/#>> "%ACL_FILE%"
    echo topic readwrite winatsvc/#>> "%ACL_FILE%"
    echo topic readwrite winttsvc/#>> "%ACL_FILE%"
    echo.>> "%ACL_FILE%"
    echo # user: facade>> "%ACL_FILE%"
    echo user facade>> "%ACL_FILE%"
    echo topic read winwtsvc/#>> "%ACL_FILE%"
    echo topic read winftsvc/#>> "%ACL_FILE%"
    echo topic read winatsvc/#>> "%ACL_FILE%"
    echo topic read winttsvc/#>> "%ACL_FILE%"
)
